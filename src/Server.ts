...
import {
  AuthSocks5Connection,
  InitialisedSocks5Connection,
...
export default class Socks5Server {
  public authHandler?: (
    connection: AuthSocks5Connection,
    accept: () => void,
    deny: () => void,
  ) => boolean | Promise<boolean> | any;
  public rulesetValidator?: (
    connection: InitialisedSocks5Connection,
    accept: () => void,
    deny: () => void,
  ) => boolean | Promise<boolean> | void;
  public connectionHandler: (
    connection: InitialisedSocks5Connection,
    sendStatus: (status: keyof typeof Socks5ConnectionStatus) => void,
  ) => void;

  public supportedCommands: Set<keyof typeof Socks5ConnectionCommand> = new Set(
    ["connect"],
  );
  ...
  listen(
    options: import("net").ListenOptions,
    listeningListener?: () => void,
  ): this;
